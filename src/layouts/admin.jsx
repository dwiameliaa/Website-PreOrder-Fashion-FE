...
export default function AdminLayout() {
  ...
  useEffect(() => {
    if (!token || !decodedData || !decodedData.success || !userInfo?.role) {
      navigate("/login");
        ...
        <nav className="bg-white border-b border-gray-200 px-4 py-2.5 dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-50">
          <div className="flex flex-wrap justify-between items-center">
            ...
            <div className="flex items-center lg:order-2">
              ...
              {/* <!-- Dropdown menu --> */}
              {dropdownOpen && (
                <div className="absolute right-2 top-full mt-2 z-50 w-56 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                  ...
                  <ul className="py-1 text-gray-700 dark:text-gray-300">
                    <li className="w-full">
                      <button
                        ...
                        className="w-full text-left py-2 px-4 text-sm hover:bg-red-600 hover:text-white rounded"
                      >
                        Keluar
                      </button>
                    </li>
